...
namespace Appccelerate.Bootstrapper.Reporting
{
    ...
    public class ReportingContextTest
    {
        ...
        {
            var runExecutionContext = this.testee.CreateRunExecutionContext(A.Fake<IDescribable>());
        ...
        {
            var shutdownExecutionContext = this.testee.CreateShutdownExecutionContext(A.Fake<IDescribable>());
        ...
        {
            var extensionContext = this.testee.CreateExtensionContext(A.Fake<IDescribable>());
