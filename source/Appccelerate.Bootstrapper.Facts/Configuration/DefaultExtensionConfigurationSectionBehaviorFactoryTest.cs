...
namespace Appccelerate.Bootstrapper.Configuration
{
    ...
    public class DefaultExtensionConfigurationSectionBehaviorFactoryTest
    {
        ...
        {
            var consumer = this.testee.CreateConsumeConfiguration(A.Fake<IExtension>());
        ...
        {
            var conversionCallbacks = this.testee.CreateHaveConversionCallbacks(A.Fake<IExtension>());
        ...
        {
            var defaultConversionCallback = this.testee.CreateHaveDefaultConversionCallback(A.Fake<IExtension>());
